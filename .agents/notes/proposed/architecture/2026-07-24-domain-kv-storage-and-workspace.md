...
| --- | --- | --- | --- |
| `@const-ai/storage` | `packages/storage/storage/` | `ctx.storage` (the hub) | ✓ |
| `@const-ai/storage-json` | `packages/storage/storage-json/` | registers backend `json` | ✓ |
| `@const-ai/storage-sqlite` | `packages/storage/storage-sqlite/` | registers backend `sqlite` | ✓ |
| `@const-ai/storage-domain` | `packages/storage/storage-domain/` | mounts `ctx.storage.domain` | ✓ |
| `@const-ai/workspace` | `packages/workspace/workspace/` | `ctx.workspaceRegistry` | ✓ |
