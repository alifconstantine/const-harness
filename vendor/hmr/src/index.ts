import { Context, Service, type Plugin } from '@const-ai/cordis'
import type { Dict } from '@const-ai/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@const-ai/cordis-plugin-loader'
import type { Include } from '@const-ai/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@const-ai/cordis-plugin-timer'
