...
Depends on: [`agentCore`](../packages/examples/agent-spine-demo/src/index.ts) · [`JsonlCompression`](../packages/session/session-persistence-jsonl/src/index.ts) · [`ToolsConfig`](#const-aitools)
...
Depends on: [`LocalConfig`](#const-aibash-local)
...
Depends on: [`LocalConfig`](#const-aifs-local)
...
Depends on: [`LocalConfig`](#const-aipwsh-local)
