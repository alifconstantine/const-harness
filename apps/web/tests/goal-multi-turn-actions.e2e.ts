...
import { parseSessionLog } from '@const-ai/llm-replay'
import type { SessionEvent, SessionId } from '@const-ai/session'
import type {} from '@const-ai/goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@const-ai/client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@const-ai/session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@const-ai/token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@const-ai/skill-filesystem"}\n',
