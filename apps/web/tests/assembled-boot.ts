...
import type { WebBootEntry } from '@const-ai/client-modules/client'
import { AppWebEntry } from '@const-ai/client-web'
...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  { id: '@const-ai/typert-registry', bundlePath: 'packages/typert/registry/lib/client.js', url: '/plugins/typert-registry.js', rev: 'fx', inject: [], immediately: true },
  { id: '@const-ai/client-connection', bundlePath: 'packages/client/connection/lib/client.js', url: '/plugins/connection.js', rev: 'fx', inject: [], immediately: true },
  { id: '@const-ai/api-gateway', bundlePath: 'packages/api/gateway/lib/client.js', url: '/plugins/api-gateway.js', rev: 'fx', inject: ['@const-ai/typert-registry', '@const-ai/client-connection'], immediately: true },
  { id: '@const-ai/api-remotes', bundlePath: 'packages/api/remotes/lib/client.js', url: '/plugins/api-remotes.js', rev: 'fx', inject: ['@const-ai/api-gateway'], immediately: true },
  ...
  { id: '@const-ai/client-ui-settings', bundlePath: 'packages/client/ui-settings/lib/client.js', url: '/plugins/ui-settings.js', rev: 'fx', inject: ['@const-ai/client-connection', '@const-ai/client-runtime', '@const-ai/api-remotes'], immediately: true },
  { id: '@const-ai/client-runtime', bundlePath: 'packages/client/runtime/lib/client.js', url: '/plugins/runtime.js', rev: 'fx', inject: ['@const-ai/client-connection', '@const-ai/typert-registry', '@const-ai/api-gateway'], immediately: true },
  { id: '@const-ai/client-ui-theme', bundlePath: 'packages/client/ui-theme/lib/client.js', url: '/plugins/ui-theme.js', rev: 'fx', inject: ['@const-ai/client-connection', '@const-ai/client-runtime', '@const-ai/client-locale', '@const-ai/client-ui-settings', '@const-ai/api-remotes'], immediately: true },
  { id: '@const-ai/client-locale', bundlePath: 'packages/client/locale/lib/client.js', url: '/plugins/locale.js', rev: 'fx', inject: ['@const-ai/client-connection', '@const-ai/client-runtime', '@const-ai/client-ui-settings', '@const-ai/api-remotes'], immediately: true },
  { id: '@const-ai/client-ui-layout', bundlePath: 'packages/client/ui-layout/lib/client.js', url: '/plugins/ui-layout.js', rev: 'fx', inject: ['@const-ai/client-runtime'] },
  { id: '@const-ai/client-ui-sidebar', bundlePath: 'packages/client/ui-sidebar/lib/client.js', url: '/plugins/ui-sidebar.js', rev: 'fx', inject: ['@const-ai/client-ui-layout'] },
  { id: '@const-ai/client-ui-conversation', bundlePath: 'packages/client/ui-conversation/lib/client.js', url: '/plugins/ui-conversation.js', rev: 'fx', inject: ['@const-ai/client-ui-layout'] },
  { id: '@const-ai/client-ui-tool', bundlePath: 'packages/client/ui-tool/lib/client.js', url: '/plugins/ui-tool.js', rev: 'fx', inject: ['@const-ai/client-runtime', '@const-ai/client-locale', '@const-ai/client-ui-conversation'] },
  { id: '@const-ai/client-ui-workflow-run', bundlePath: 'packages/client/ui-workflow-run/lib/client.js', url: '/plugins/ui-workflow-run.js', rev: 'fx', inject: ['@const-ai/client-locale', '@const-ai/client-runtime', '@const-ai/client-ui-conversation'] },
  {
    id: '@const-ai/client-ui-workspace',
    bundlePath: 'packages/client/ui-workspace/lib/client.js',
    url: '/plugins/ui-workspace.js',
    rev: 'fx',
    inject: [
      '@const-ai/client-runtime',
      '@const-ai/client-ui-conversation',
      '@const-ai/client-ui-sidebar',
    ],
  },
  { id: '@const-ai/session-log-export', bundlePath: 'packages/session-query/session-log-export/lib/client.js', url: '/plugins/session-log-download.js', rev: 'fx', inject: ['@const-ai/client-ui-commands', '@const-ai/client-ui-conversation'] },
  { id: '@const-ai/client-ui-trajectory', bundlePath: 'packages/client/ui-trajectory/lib/client.js', url: '/plugins/ui-trajectory.js', rev: 'fx', inject: ['@const-ai/client-ui-conversation'] },
]
