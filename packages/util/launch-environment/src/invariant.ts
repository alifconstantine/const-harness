/**
 * Package-owned invariant companion for `@const-ai/launch-environment`.
 * @module @const-ai/launch-environment/invariant
 */
...
const PACKAGE_NAME = '@const-ai/launch-environment'
