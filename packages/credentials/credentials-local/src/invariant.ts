/**
 * Package-owned invariant companion for `@const-ai/credentials-local`.
 * @module @const-ai/credentials-local/invariant
 */
...
const PACKAGE_NAME = '@const-ai/credentials-local'
