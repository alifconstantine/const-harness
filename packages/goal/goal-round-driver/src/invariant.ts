/** Package-owned goal-round prompt invariants. @module @const-ai/goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@const-ai/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@const-ai/goal'
...
const PACKAGE_NAME = '@const-ai/goal-round-driver'
