/**
 * Package-owned invariant companion for `@const-ai/workspace`.
 * @module @const-ai/workspace/invariant
 */
...
import { WorkspaceId } from '@const-ai/workspace'

const PACKAGE_NAME = '@const-ai/workspace'
