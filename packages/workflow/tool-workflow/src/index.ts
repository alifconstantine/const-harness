 ...
 * (`@const-ai/workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @const-ai/tool-workflow
 */

import type { Context } from '@const-ai/cordis'
import z from '@const-ai/schemastery'
import { defineTool } from '@const-ai/tools'
import type { ToolCallView, ToolResultView } from '@const-ai/tools'
import type { ContentBlock } from '@const-ai/llm'
import type { JsonValue, Session, SessionEventMap } from '@const-ai/session'
import type {
