/**
 * Package-owned invariant companion for `@const-ai/workflow-worker-thread`.
 * @module @const-ai/workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@const-ai/workflow-worker-thread'
