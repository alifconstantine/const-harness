/** Package-owned invariant companion for `@const-ai/attachment-local`. @module @const-ai/attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@const-ai/cordis'
import type { InvariantInstaller } from '@const-ai/invariants'

const PACKAGE_NAME = '@const-ai/attachment-local'
