/**
 * Package-owned invariant companion for `@const-ai/anonymous-user-id`.
 * @module @const-ai/anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@const-ai/anonymous-user-id'
