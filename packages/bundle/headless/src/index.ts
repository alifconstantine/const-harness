/**
 * @const-ai/headless — one-shot direct Agent driver. The bundle patch
...
import type { ModelSelectionRef } from '@const-ai/agent'
import type {} from '@const-ai/agent-default-model'
...
import type {} from '@const-ai/cmdline'
...
async function run(ctx: Context, task: string, io: HeadlessIo): Promise<void> {
  ...
  // (@const-ai/agent-presets README, "Composing a child agent").
