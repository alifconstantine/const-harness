/**
 * Package-owned invariant companion for `@const-ai/tool-subagent-report`.
 * @module @const-ai/tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@const-ai/tool-subagent-report'
