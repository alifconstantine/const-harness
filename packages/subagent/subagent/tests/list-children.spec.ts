...
import type { ProjectionDefinition } from '@const-ai/session-projection'
import SessionProjectionCache from '@const-ai/session-projection-cache'
import Storage from '@const-ai/storage'
import { DomainFacility } from '@const-ai/storage-domain'
import { MemoryMediaPool, MemoryStorageBackend } from '../../../storage/storage-domain/tests/helpers/memory-backend.ts'
import SubagentRuntime, {
  SUBAGENT_DESCRIPTOR_VERSION,
  SubagentError,
} from '@const-ai/subagent'
import * as SubagentSpawn from '@const-ai/subagent-spawn-in-process'
import * as SubagentFork from '@const-ai/subagent-fork-in-process'
...
declare module '@const-ai/session-projection/types' {
