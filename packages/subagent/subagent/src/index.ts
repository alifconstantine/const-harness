 ...
 * (`@const-ai/subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@const-ai/tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@const-ai/tools'
import type { ContentBlock, MessageId } from '@const-ai/llm'
