/**
 * Package-owned invariant companion for `@const-ai/tool-subagent-control`.
 * @module @const-ai/tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@const-ai/tool-subagent-control'
