...
import { SANDBOX_MODES, effectiveSandboxMode, setSandboxMode } from '@const-ai/sandbox-policy'
...
import type {} from '@const-ai/shell'
import type { ApprovalPolicy } from '@const-ai/user-approval'
import { APPROVAL_POLICIES, effectiveApprovalPolicy, setApprovalPolicy } from '@const-ai/user-approval'
import { installSettingsSection, settingsNamespace } from '@const-ai/settings'
...
declare module '@const-ai/session/types' {
