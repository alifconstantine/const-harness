 ...
 * @module @const-ai/app-boot/profile
 */
...
import { applyEntryPatches, type PatchOptions } from '@const-ai/cordis-plugin-include'
...
export const PROFILE_TEMPLATES: Record<string, readonly string[]> = {
  web: ['@const-ai/base', '@const-ai/web-app'],
  headless: ['@const-ai/base', '@const-ai/headless'],
}
...
export const DEFAULT_PROFILE_BUNDLES: readonly string[] = ['@const-ai/base']
 ...
 * `@const-ai/base` (and every other in-box bundle) always comes from
