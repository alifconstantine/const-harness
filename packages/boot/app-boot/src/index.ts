...
import { Context, type FiberState } from '@const-ai/cordis'
import Loader, { type Entry, type EntryOptions } from '@const-ai/cordis-plugin-loader'
import Include, { applyEntryPatches, entryListSchema, type PatchOptions } from '@const-ai/cordis-plugin-include'
import Group from '@const-ai/cordis-plugin-group'
import { dshHomePath, resolveDshHome } from '@const-ai/home-paths'
import { createLaunchEnvironmentSnapshot, type LaunchEnvironmentSnapshot } from '@const-ai/launch-environment'
import type {} from '@const-ai/cordis-plugin-hmr'
 ...
 * entries (`@const-ai/cordis-plugin-include`'s `PatchOptions`): id-targeted config
 ...
 * `@const-ai/cordis-plugin-include` `PatchOptions` (id-targeted config overrides and
...
export async function mountRootInclude(
  ...
  // preset living outside this workspace cannot resolve `@const-ai/cordis-plugin-group`
