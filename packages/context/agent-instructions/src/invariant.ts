/**
 * Package-owned invariant companion for `@const-ai/agent-instructions`.
 * @module @const-ai/agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@const-ai/agent-instructions'
