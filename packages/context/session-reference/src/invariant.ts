/**
 * Package-owned invariant companion for `@const-ai/session-reference`.
 * @module @const-ai/session-reference/invariant
 */
...
const PACKAGE_NAME = '@const-ai/session-reference'
