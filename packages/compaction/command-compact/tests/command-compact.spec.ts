...
import CommandRuntime, { type CommandResult } from '@const-ai/commands'
import {
  CompactionId,
  CompactionEngine,
...
import * as commandCompact from '@const-ai/command-compact'
...
describe('@const-ai/command-compact registration', () => {
