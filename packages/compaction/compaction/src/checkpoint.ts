 ...
 *
 * The seam itself lives in `@const-ai/compaction`, which re-exports these
 ...
 *
 * @module @const-ai/compaction/checkpoint
 */

import type { MessageSource } from '@const-ai/llm/message'
