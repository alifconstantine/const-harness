 ...
 *
 * @module @const-ai/compaction-tool-result-pruner
 */

import { Context, Service } from '@const-ai/cordis'
import z from '@const-ai/schemastery'
import { freezeMessage } from '@const-ai/llm'
import type { ContentBlock } from '@const-ai/llm'
import type { Session, SessionEvent, ToolResultMessage } from '@const-ai/session'
// Type-only: the `compaction/*` SessionEventMap merges (the shadow-price event).
import type {} from '@const-ai/compaction'
