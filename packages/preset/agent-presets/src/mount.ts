 ...
 * @module @const-ai/agent-presets/mount
 */
...
import type { EntryTree } from '@const-ai/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@const-ai/scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@const-ai/*` row would fail to import. The
