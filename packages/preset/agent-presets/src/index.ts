 ...
 * @module @const-ai/agent-presets
 */

import { stat } from 'node:fs/promises'
import { Context, Service } from '@const-ai/cordis'
import z from '@const-ai/schemastery'
import { bindScopeParent, createScope, scopeOf, type Scope, type ScopeKey, type ScopeParentBinding } from '@const-ai/scope'
// Type-only: resolves the `agent/created` lifecycle event this service watches.
import type {} from '@const-ai/agent'
import { settingsNamespace, type SettingsScope, type default as SettingsService } from '@const-ai/settings'
