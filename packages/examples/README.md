...
|---|---|---|
| [`agent-spine-demo/`](agent-spine-demo/README.md) | `@const-ai/agent-spine-demo` | Reusable agent-spine bundle |
| [`acp-demo/`](acp-demo/README.md) | `@const-ai/acp-demo` | ACP automation application bundle |
| [`jsonrpc-demo/`](jsonrpc-demo/README.md) | `@const-ai/sdk-jsonrpc-demo` | External-config JSON-RPC runtime |
