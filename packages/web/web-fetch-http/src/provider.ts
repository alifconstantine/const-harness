 ...
 * `@const-ai/tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @const-ai/web-fetch-http/provider
 */

import { WebError } from '@const-ai/web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@const-ai/web'
