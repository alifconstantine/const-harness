...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@const-ai/tools'
import type { WebFetchBody, WebFetchResult } from '@const-ai/web'
 ...
 * `@const-ai/tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@const-ai/tool-call-timeout-policy` to enforce.
