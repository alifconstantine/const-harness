/**
 * Package-owned invariant companion for `@const-ai/web-search-deepseek`.
 * @module @const-ai/web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@const-ai/web-search-deepseek'
