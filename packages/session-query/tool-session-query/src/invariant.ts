/**
 * Package-owned invariant companion for `@const-ai/tool-session-query`.
 * @module @const-ai/tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@const-ai/tool-session-query'
