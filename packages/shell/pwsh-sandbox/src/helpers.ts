 ...
 * mirror of `@const-ai/bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @const-ai/pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@const-ai/shell'
import type { RunnerFailureRule } from '@const-ai/sandbox'
