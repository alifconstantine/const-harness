 ...
 * `@const-ai/bash-sandbox`. It wraps the exact local pwsh argv through
 ...
 * renders.
 * @module @const-ai/pwsh-sandbox
 */

import { Context } from '@const-ai/cordis'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellRunResult } from '@const-ai/shell'
import { SandboxUnavailableError } from '@const-ai/sandbox'
import type {
  ConfinedArgv,
  ConfinedSandboxMode,
  RunnerFailureRule,
