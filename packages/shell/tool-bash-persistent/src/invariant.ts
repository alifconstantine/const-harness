/**
 * Package-owned invariant companion for `@const-ai/tool-bash-persistent`.
 * @module @const-ai/tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@const-ai/tool-bash-persistent'
