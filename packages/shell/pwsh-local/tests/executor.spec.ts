/**
 * Real-process tests for `@const-ai/pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@const-ai/pwsh-local'
import LocalSubprocessRuntime from '@const-ai/subprocess-local'
import SubprocessRuntime from '@const-ai/subprocess'
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@const-ai/subprocess'
import { MAX_TIMER_DELAY_MS } from '@const-ai/timeout'
import type { ShellProcess } from '@const-ai/shell'
