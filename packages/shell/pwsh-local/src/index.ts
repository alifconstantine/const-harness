...
import { SHELL_SETTINGS_NAMESPACE, ShellExecutor } from '@const-ai/shell'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellProcessRead, ShellRunResult, CollectedOutput } from '@const-ai/shell'
import type { SubprocessCollect, SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@const-ai/subprocess'
import { installSettingsSection } from '@const-ai/settings'
import { clampTimeout, deadline, MAX_TIMER_DELAY_MS, timeoutOf } from '@const-ai/timeout'
/* jscpd:ignore-end */
...
export class PwshLocalExecutor extends ShellExecutor {
   ...
   * pwsh-confining consumer is `@const-ai/pwsh-sandbox`.
