 ...
 *
 * @module @const-ai/tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@const-ai/shell'
 ...
 * rendering story, owned by `@const-ai/shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@const-ai/shell'
