...
The model sees the generated [`pwsh` schema](../../../docs/tool-catalog.md#const-aitool-pwsh). Agent-scoped tool restrictions can remove the definition for that agent.
