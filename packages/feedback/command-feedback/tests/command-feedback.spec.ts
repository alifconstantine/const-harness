...
import SessionStore, { foldSurface, Session, SessionId } from '@const-ai/session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@const-ai/session-telemetry'
...
vi.mock('@const-ai/anonymous-user-id', () => ({
...
describe('@const-ai/command-feedback registration', () => {
