 ...
 * @module @const-ai/message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@const-ai/cordis'
import s from '@const-ai/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@const-ai/session/surface'
import type { SessionHeader, SessionId } from '@const-ai/session/types'
import type { SessionInspection } from '@const-ai/session-persistence'
import type { KvTable } from '@const-ai/storage-domain'
import { TypertRemoteService, Remote } from '@const-ai/typert-protocol'
