...
Public request, value, version, and failure types are exported from the package root and `@const-ai/message-feedback/types`; [`src/types.ts`](src/types.ts) is their source.
