 ...
 * @module @const-ai/cordis-host-runner/guard
 */

import { Context } from '@const-ai/cordis'
import type { Plugin } from '@const-ai/cordis'
import { scopeOf } from '@const-ai/scope'
import { assertSupportedJsonSchema, defineTool } from '@const-ai/tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@const-ai/cordis-client-runner`, whose CTX_VERBS names this one its
