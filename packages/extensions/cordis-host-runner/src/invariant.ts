/**
 * Package-owned invariant companion for `@const-ai/cordis-host-runner`.
 * @module @const-ai/cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@const-ai/cordis-host-runner'
