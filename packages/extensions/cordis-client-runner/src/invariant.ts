/**
 * Package-owned invariant companion for `@const-ai/cordis-client-runner`.
 * @module @const-ai/cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@const-ai/cordis-client-runner'
