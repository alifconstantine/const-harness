...
} from '@const-ai/session-telemetry'
import { APP_IDENTITY } from '@const-ai/llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@const-ai/session-telemetry-otel', version)
    const ops = this.provider.getLogger('@const-ai/session-telemetry-otel/ops', version)
