/**
 * Package-owned invariant companion for `@const-ai/session-telemetry-otel`.
 * @module @const-ai/session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@const-ai/session-telemetry-otel'
