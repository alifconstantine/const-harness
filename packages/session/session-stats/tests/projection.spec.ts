...
import { createMessage } from '@const-ai/llm'
...
import { sessionStatsProjectionDefinition } from '@const-ai/session-stats/src/projection.ts'
import type { SessionStatsProjection } from '@const-ai/session-stats/types'
