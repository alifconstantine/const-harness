/**
 * Package-owned invariant companion for `@const-ai/session-checkpoint-policy`.
 * @module @const-ai/session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@const-ai/session-checkpoint-policy'
