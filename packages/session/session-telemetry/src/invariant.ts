/**
 * Package-owned invariant companion for `@const-ai/session-telemetry`.
 * @module @const-ai/session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@const-ai/session-telemetry'
