/**
 * Package-owned invariant companion for `@const-ai/session-projection`.
 * @module @const-ai/session-projection/invariant
 */
...
const PACKAGE_NAME = '@const-ai/session-projection'
