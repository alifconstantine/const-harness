/**
 * Package-owned invariant companion for `@const-ai/session-title-first-prompt-llm`.
 * @module @const-ai/session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@const-ai/session-title-first-prompt-llm'
