/**
 * Package-owned invariant companion for `@const-ai/session-title-all-prompts-llm`.
 * @module @const-ai/session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@const-ai/session-title-all-prompts-llm'
