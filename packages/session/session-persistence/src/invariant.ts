/**
 * Package-owned invariant companion for `@const-ai/session-persistence`.
 * @module @const-ai/session-persistence/invariant
 */
...
const PACKAGE_NAME = '@const-ai/session-persistence'
