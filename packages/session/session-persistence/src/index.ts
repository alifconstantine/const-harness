 ...
 * @module @const-ai/session-persistence
 */

import { Context, Service } from '@const-ai/cordis'
import { SessionPreparation } from '@const-ai/session'
import type { SessionEvent, SessionId, SessionHeader } from '@const-ai/session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@const-ai/session'
