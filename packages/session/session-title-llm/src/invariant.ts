/**
 * Package-owned invariant companion for `@const-ai/session-title-llm`.
 * @module @const-ai/session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@const-ai/session-title-llm'
