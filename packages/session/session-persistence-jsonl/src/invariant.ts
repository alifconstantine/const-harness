/**
 * Package-owned invariant companion for `@const-ai/session-persistence-jsonl`.
 * @module @const-ai/session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@const-ai/session-persistence-jsonl'
