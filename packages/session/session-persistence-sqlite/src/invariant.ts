/**
 * Package-owned invariant companion for `@const-ai/session-persistence-sqlite`.
 * @module @const-ai/session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@const-ai/session-persistence-sqlite'
