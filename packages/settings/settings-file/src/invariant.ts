/**
 * Package-owned invariant companion for `@const-ai/settings-file`.
 * @module @const-ai/settings-file/invariant
 */
...
const PACKAGE_NAME = '@const-ai/settings-file'
 ...
 * tests; the in-process commit relation is owned by `@const-ai/settings`.
 */
