/**
 * Package-owned invariant companion for `@const-ai/jobs-local`.
 * @module @const-ai/jobs-local/invariant
 */
...
const PACKAGE_NAME = '@const-ai/jobs-local'
...
/**
 * No runtime invariant: `@const-ai/jobs/invariant` owns per-snapshot identity, status,
