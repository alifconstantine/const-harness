...
export const API_REMOTE_FORWARDED_EVENTS = [
  ...
  'commands/change',
  'credentials/updated',
  '@const-ai/cordis/request-run',
  '@const-ai/cordis/request-run-resolved',
  '@const-ai/cordis/dynamic-package',
  '@const-ai/cordis/dynamic-retract',
  '@const-ai/cordis/inspect-query',
  '@const-ai/cordis/inspect-query-resolved',
