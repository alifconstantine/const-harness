 ...
 * Concrete
 * providers such as `@const-ai/skill-filesystem` decide where skills come
 ...
 *
 * @module @const-ai/skill
 */

import { Context, Service } from '@const-ai/cordis'
import { assertNever } from '@const-ai/llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@const-ai/scope'
import type { ScopeKey, ScopeLayer } from '@const-ai/scope'
import z from '@const-ai/schemastery'
import type Schema from '@const-ai/schemastery'
