/**
 * Package-owned invariant companion for `@const-ai/hooks-claude-code`.
 * @module @const-ai/hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@const-ai/hooks-claude-code'
