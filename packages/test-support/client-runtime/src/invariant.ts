/**
 * Package-owned invariant companion for `@const-ai/client-test-runtime`.
 * @module @const-ai/client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-test-runtime'
