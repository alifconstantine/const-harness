/**
 * Package-owned invariant companion for `@const-ai/agent-loop-testkit`.
 * @module @const-ai/agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@const-ai/agent-loop-testkit'
