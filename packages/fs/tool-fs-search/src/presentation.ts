 ...
 * model-facing render consumes ({@link module:@const-ai/tool-fs-search/search-core}
 ...
 *
 * @module @const-ai/tool-fs-search/presentation
 */
 ...
 * ({@link module:@const-ai/tool-fs-search/grep} `formatGrepMatches`), so
