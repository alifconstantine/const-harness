...
The generated [`str_replace_editor` schema](../../../docs/tool-catalog.md#const-aitool-str-replace-editor), including the configured `description`. The plugin contributes no standalone system-prompt section.
