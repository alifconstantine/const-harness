/**
 * Package-owned invariant companion for `@const-ai/tool-str-replace-editor`.
 * @module @const-ai/tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@const-ai/tool-str-replace-editor'
