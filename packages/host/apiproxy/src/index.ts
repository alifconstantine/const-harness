/**
 * @const-ai/host-apiproxy — the API gateway every client shape shares:
...
import { constDefaultWorkspacePath } from '@const-ai/home-paths'
...
export class ApiProxyService extends Service implements ApiProxy {
  ...
  readonly automations: ApiProxy['automations']
  readonly design: ApiProxy['design']
  ...
  constructor(ctx: Context, config: Config) {
    ...
    this.llm = api.llm
    this.automations = api.automations
    this.design = api.design
