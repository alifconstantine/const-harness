...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('design-system-not-found'), message: z.string(), details: z.object({ id: z.string() }) }),
  z.object({ code: z.literal('design-template-not-found'), message: z.string(), details: z.object({ id: z.string() }) }),
  z.object({ code: z.literal('craft-guideline-not-found'), message: z.string(), details: z.object({ id: z.string() }) }),
  z.object({ code: z.literal('prompt-template-not-found'), message: z.string(), details: z.object({ id: z.string() }) }),
