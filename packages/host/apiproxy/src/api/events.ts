...
import type { AskUserQuestionItem } from '@const-ai/user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@const-ai/user-approval/types'
import type { Message } from '@const-ai/llm/types'
import type { MessageId } from '@const-ai/llm/brand'
import type { CallId } from '@const-ai/llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@const-ai/session/types'
import type { ToolCallView, ToolResultView } from '@const-ai/tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@const-ai/api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
