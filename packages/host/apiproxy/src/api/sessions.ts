...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@const-ai/attachment'
import type { ContentBlock } from '@const-ai/llm/types'
import type { SessionEvent, SessionId } from '@const-ai/session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via dsh-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@const-ai/session-projection/types'
