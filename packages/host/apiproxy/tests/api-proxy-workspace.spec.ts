...
import type { Agent, AgentFactory } from '@const-ai/agent'
...
import type { DirectoryPickerCapability } from '@const-ai/host-directory-picker'
import WorkspaceRegistry from '@const-ai/workspace'
import type { HostFrame, WorkspaceId } from '@const-ai/host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@const-ai/host-apiproxy/api/rpc'
