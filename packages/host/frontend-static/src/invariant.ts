/**
 * Package-owned invariant companion for `@const-ai/host-frontend-static`.
 * @module @const-ai/host-frontend-static/invariant
 */

import type { Context } from '@const-ai/cordis'
import type { InvariantInstaller } from '@const-ai/invariants'

const PACKAGE_NAME = '@const-ai/host-frontend-static'
