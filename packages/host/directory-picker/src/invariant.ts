/** Package-owned invariant companion for the directory-picker seam. @module @const-ai/host-directory-picker/invariant */

import type { Context } from '@const-ai/cordis'
import type { InvariantInstaller } from '@const-ai/invariants'

const PACKAGE_NAME = '@const-ai/host-directory-picker'
