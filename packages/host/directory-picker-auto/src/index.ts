 ...
 * @module @const-ai/host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@const-ai/host-directory-picker-native',
  browse: '@const-ai/host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@const-ai/client-ui-directory-picker-native',
  browse: '@const-ai/client-ui-directory-picker-browse',
}
