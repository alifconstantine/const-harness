...
import HttpServer from '@const-ai/host-webserver'
import type { DirectoryPicker } from '@const-ai/host-directory-picker'
import BrowseDirectoryPicker from '@const-ai/host-directory-picker-browse'
import NativeDirectoryPicker from '@const-ai/host-directory-picker-native'
...
const AUTO = '@const-ai/host-directory-picker-auto'
const NATIVE = '@const-ai/host-directory-picker-native'
const BROWSE = '@const-ai/host-directory-picker-browse'
const NATIVE_SURFACE = '@const-ai/client-ui-directory-picker-native'
const BROWSE_SURFACE = '@const-ai/client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  const modules = new Map<string, unknown>([
    ['@const-ai/host-webserver', HttpServer],
