/**
 * Package-owned invariant companion for `@const-ai/code-runtime-worker-thread`.
 * @module @const-ai/code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@const-ai/code-runtime-worker-thread'
