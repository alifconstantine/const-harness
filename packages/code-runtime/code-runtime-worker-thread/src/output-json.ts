/** JSON string-prefix accounting for the outer-output ledger. @module @const-ai/code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@const-ai/code-runtime'
