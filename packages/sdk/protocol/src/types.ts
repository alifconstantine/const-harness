 ...
 * plugin (`@const-ai/sdk-jsonrpc-server`) and SDK clients share these shapes;
 * `serverInfo.name` stays the wire-stable `deepseek-harness-sdk-runtime`.
 *
 * @module @const-ai/sdk-protocol/types
 */

import type { ContentBlock } from '@const-ai/llm'
import type { SessionEvent } from '@const-ai/session'
import type { SubagentStopReason } from '@const-ai/subagent'
