/**
 * Package-owned invariant companion for `@const-ai/sdk-jsonrpc-server`.
 * @module @const-ai/sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@const-ai/sdk-jsonrpc-server'
