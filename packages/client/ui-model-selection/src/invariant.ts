/**
 * Package-owned invariant companion for `@const-ai/client-ui-model-selection`.
 * @module @const-ai/client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-model-selection'
