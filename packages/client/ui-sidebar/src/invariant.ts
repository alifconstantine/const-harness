/**
 * Package-owned invariant companion for `@const-ai/client-ui-sidebar`.
 * @module @const-ai/client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-sidebar'
