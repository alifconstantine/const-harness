/**
 * Package-owned invariant companion for `@const-ai/client-ui-primitives`.
 * @module @const-ai/client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-primitives'
