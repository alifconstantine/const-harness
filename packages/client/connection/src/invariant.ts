/**
 * Package-owned invariant companion for `@const-ai/client-connection`.
 * @module @const-ai/client-connection/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-connection'
