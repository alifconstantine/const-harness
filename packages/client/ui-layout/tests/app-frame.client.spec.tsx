...
import { AppFrame } from '@const-ai/client-ui-layout/src/client/AppFrame.tsx'
import type { AppFrameProps } from '@const-ai/client-ui-layout/src/client/AppFrame.tsx'
import { SIDEBAR_COLLAPSED } from '@const-ai/client-ui-layout/src/client/columns.ts'
import { createLayoutStore } from '@const-ai/client-ui-layout/src/client/stores.ts'
import type {
...
describe('AppFrame', () => {
  ...
  it('drag base is the rendered (concession-clamped) width, not the preference', () => {
    frameWidth = 1350 // step-2 squeeze: details renders 430 while preference is 480
    const { frame, instance } = mountFrame()
    act(() => { instance.actions.openDetails() })
