...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@const-ai/client-ui-theme/client'
import { apply, inject, LayoutController } from '@const-ai/client-ui-layout/client'
import { apply as nodeApply } from '@const-ai/client-ui-layout'
import * as invariant from '@const-ai/client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@const-ai/client-ui-layout', expect.any(Function))
