/**
 * Package-owned invariant companion for `@const-ai/client-ui-input-trigger`.
 * @module @const-ai/client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-input-trigger'
