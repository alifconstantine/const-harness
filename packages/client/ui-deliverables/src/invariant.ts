/**
 * Package-owned invariant companion for `@const-ai/client-ui-deliverables`.
 * @module @const-ai/client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-deliverables'
