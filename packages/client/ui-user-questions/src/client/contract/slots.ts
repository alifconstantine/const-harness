 ...
 * that consumes it.
 */
import type { PropsLocale, PropsRuntime } from '@const-ai/client-ui-slots'
...
import type { PendingWait } from '@const-ai/client-runtime/client'
import type { QuestionResponsePayload } from '@const-ai/api-remotes/client'
