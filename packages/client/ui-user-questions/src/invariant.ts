/**
 * Package-owned invariant companion for `@const-ai/client-ui-user-questions`.
 * @module @const-ai/client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-user-questions'
