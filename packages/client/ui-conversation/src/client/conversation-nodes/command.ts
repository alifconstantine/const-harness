...
import { isReplacementSurfaceEvent } from '@const-ai/client-runtime/client'
import type { CompactionCheckpointSource } from '@const-ai/compaction/checkpoint'
import type {} from '@const-ai/compaction/types'
import type {} from '@const-ai/commands/types'
import type { ManualCompactionChatData } from '../contract/chat-nodes.ts'
import { chatNode } from './common.ts'

declare module '@const-ai/client-ui-conversation/client' {
