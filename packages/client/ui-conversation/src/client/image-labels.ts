 ...
 * atoms' label props (`@const-ai/client-ui-attachment` reads no
...
} from '@const-ai/client-ui-attachment'
import type { ImageAttachmentLimits } from '@const-ai/attachment'
import type { Translate } from '@const-ai/client-ui-slots'
