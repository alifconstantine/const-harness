...
export const zh = {
  ...
  'hero.outsideProject': 'Outside Project',
...
export const en = {
  ...
  'input.attachFiles': 'Attach files or photos',
  ...
  'message.edit': 'Edit',
  'message.restorePrompt': 'Restore prompt',
