/**
 * Package-owned invariant companion for `@const-ai/client-ui-conversation`.
 * @module @const-ai/client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-conversation'
