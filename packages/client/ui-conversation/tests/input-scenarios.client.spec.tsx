...
import { InputTriggerService } from '@const-ai/client-ui-input-trigger/client'
import type { ClientSessionContext, CommandClaim, PickOutcome, SubmitOutcome } from '@const-ai/client-ui-input-trigger/client'
...
import { createSnapshotStore } from '@const-ai/client-runtime/client'
import type { ConversationSnapshot } from '@const-ai/client-runtime/client'
