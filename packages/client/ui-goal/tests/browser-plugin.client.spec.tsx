...
import { SlotRegistry, type SessionId } from '@const-ai/client-runtime/client'
import { ConversationEventRegistry } from '@const-ai/client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@const-ai/goal/client'
