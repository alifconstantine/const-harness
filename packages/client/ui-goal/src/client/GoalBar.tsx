...
import type { GoalSnapshot } from '@const-ai/goal/client'
import {
...
import type { PropsLocale } from '@const-ai/client-ui-slots'
...
export type GoalDockProps = import('@const-ai/client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
