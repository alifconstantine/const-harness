/**
 * Package-owned invariant companion for `@const-ai/client-ui-attachment`.
 * @module @const-ai/client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-attachment'
