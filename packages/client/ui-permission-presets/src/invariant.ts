/**
 * Package-owned invariant companion for `@const-ai/client-ui-permission-presets`.
 * @module @const-ai/client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-permission-presets'
