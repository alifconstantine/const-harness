/**
 * Package-owned invariant companion for `@const-ai/client-ui-message-feedback`.
 * @module @const-ai/client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-message-feedback'
