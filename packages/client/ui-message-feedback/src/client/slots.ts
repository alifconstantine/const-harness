 ...
 * @module @const-ai/client-ui-message-feedback/client/slots
 */

import type {
  HostObservable, InjectFace, PropsLocale, PropsRuntime,
} from '@const-ai/client-ui-slots'
import type {} from '@const-ai/client-ui-conversation/client'
import type { MessageId } from '@const-ai/client-connection/client'
import type { MessageFeedbackRating } from '@const-ai/message-feedback/types'
