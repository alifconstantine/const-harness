 ...
 * @module @const-ai/client-ui-message-feedback/client/controller
 */

import type { RemoteResult } from '@const-ai/typert-protocol'
import type { HostObservable } from '@const-ai/client-ui-slots'
import type { MessageId, SessionId } from '@const-ai/client-connection/client'
import type {
...
} from '@const-ai/message-feedback/types'
