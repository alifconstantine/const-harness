/**
 * Package-owned invariant companion for `@const-ai/client-ui-agent-preset`.
 * @module @const-ai/client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-agent-preset'
