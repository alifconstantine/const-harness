/**
 * Package-owned invariant companion for `@const-ai/client-ui-directory-picker-browse`.
 * @module @const-ai/client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-directory-picker-browse'
