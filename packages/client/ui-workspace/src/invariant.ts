/**
 * Package-owned invariant companion for `@const-ai/client-ui-workspace`.
 * @module @const-ai/client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-workspace'
