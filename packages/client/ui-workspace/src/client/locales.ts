...
export const zh = {
  ...
  'archive.delete': '删除会话',
  'archive.search.placeholder': '搜索归档会话…',
  'archive.noMatches': '无匹配归档会话',
  'delete.session': '删除会话',
  'delete.session.desc': '将把“{name}”从归档会话中永久删除。会话记录将被移除，此操作无法撤销。',
...
export const en = {
  ...
  'archive.unarchive': 'Unarchive session',
  'archive.delete': 'Delete session',
  'archive.search.placeholder': 'Search archived sessions...',
  'archive.noMatches': 'No matching archived sessions',
  'delete.session': 'Delete session',
  'delete.session.desc': 'This will permanently delete “{name}” from archived sessions. This action cannot be undone.',
