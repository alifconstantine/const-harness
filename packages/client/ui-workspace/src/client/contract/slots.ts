 ...
 */
import type { HostObservable, PropsLocale, PropsRenderSlots, PropsRuntime, PropsStore, SnapshotSelectorHook } from '@const-ai/client-ui-slots'
// Type-only: pull the owner SlotMap merges into programs that resolve the
// runtime shares below.
import type {} from '@const-ai/client-ui-sidebar/client'
import type {} from '@const-ai/client-ui-conversation/client'
import type {
...
export type WorkspaceBrowserInjected = DirectoryPickingInjected & {
  ...
  /** Unarchive a Session from the registry-global set, restoring it to grouping surfaces. */
  unarchiveSession?: (sessionId: SessionId) => Promise<void>
  /** Delete a Session permanently and remove from archive and storage. */
