/**
 * Package-owned invariant companion for `@const-ai/client-ui-settings-general`.
 * @module @const-ai/client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-settings-general'
