/**
 * Package-owned invariant companion for `@const-ai/client-ui-subagent`.
 * @module @const-ai/client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-subagent'
