/**
 * Package-owned invariant companion for `@const-ai/client-schema-form`.
 * @module @const-ai/client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-schema-form'
