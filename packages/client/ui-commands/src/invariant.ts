/**
 * Package-owned invariant companion for `@const-ai/client-ui-commands`.
 * @module @const-ai/client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-commands'
