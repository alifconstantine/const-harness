/**
 * Package-owned invariant companion for `@const-ai/client-ui-settings`.
 * @module @const-ai/client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-settings'
