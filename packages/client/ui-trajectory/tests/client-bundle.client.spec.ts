 ...
 * not built (`pnpm --filter @const-ai/client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@const-ai/client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@const-ai/client-runtime/client', await import('@const-ai/client-runtime/client')],
      ['@const-ai/client-ui-primitives', await import('@const-ai/client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@const-ai/client-locale/client')
