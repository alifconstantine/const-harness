/**
 * Package-owned invariant companion for `@const-ai/client-ui-trajectory`.
 * @module @const-ai/client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-trajectory'
