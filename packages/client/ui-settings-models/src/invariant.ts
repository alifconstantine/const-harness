/**
 * Package-owned invariant companion for `@const-ai/client-ui-settings-models`.
 * @module @const-ai/client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-settings-models'
