/**
 * Package-owned invariant companion for `@const-ai/client-ui-settings-plugins`.
 * @module @const-ai/client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-settings-plugins'
