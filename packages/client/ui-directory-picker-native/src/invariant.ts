/**
 * Package-owned invariant companion for `@const-ai/client-ui-directory-picker-native`.
 * @module @const-ai/client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@const-ai/client-ui-directory-picker-native'
