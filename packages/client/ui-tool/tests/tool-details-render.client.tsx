...
import type { SessionProviderComponent, TranslateNS } from '@const-ai/client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@const-ai/client-ui-conversation/src/client/contract/slots.ts'
