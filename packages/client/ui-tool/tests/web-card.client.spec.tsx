...
import type { ToolResultView } from '@const-ai/api-remotes/client'
import { bindSnapshotSelector } from '@const-ai/client-web-react'
import type { SelectionTarget } from '@const-ai/client-ui-conversation/client'
import type { ToolCallOwnerProps } from '@const-ai/client-ui-tool/client'
import { IconGlobeOutline14 } from '@const-ai/client-ui-primitives'
...
import { zh as commonZh } from '@const-ai/client-locale/src/locales/zh.ts'
import { zh } from '@const-ai/client-ui-conversation/src/client/locales.ts'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@const-ai/cordis').Context
