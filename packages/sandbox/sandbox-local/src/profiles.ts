 ...
 *
 * @module @const-ai/sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@const-ai/node-addon-landlock-run'
import { writableRoots } from '@const-ai/sandbox'
import type { SandboxPolicy } from '@const-ai/sandbox'
 ...
 * (`@const-ai/fs-sandbox`) can never drift apart.
