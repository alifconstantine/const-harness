/**
 * Package-owned invariant companion for `@const-ai/sandbox-windows-acl`.
 * @module @const-ai/sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@const-ai/sandbox-windows-acl'
