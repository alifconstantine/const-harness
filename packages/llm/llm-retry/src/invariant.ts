/** Package-owned durable retry-event invariants. @module @const-ai/llm-retry/invariant */

import type { Context } from '@const-ai/cordis'
import type { Session, SessionEvent } from '@const-ai/session'
import type { LlmFailure } from '@const-ai/llm'
...
const PACKAGE_NAME = '@const-ai/llm-retry'
