...
import SystemPrompt, { AssembleContext, PromptAssembly, renderContextSnapshot, renderPrompt } from '@const-ai/system-prompt'
...
const IDENTITY = 'You are an AI agent powered by Const Harness.'
