...
import { bindScopeParent, createScope } from '@const-ai/scope'
...
import type { PreToolDecision, ToolDefinition, ToolExecution, ToolExecutionInput, ToolExecutionToken } from '@const-ai/tools'
