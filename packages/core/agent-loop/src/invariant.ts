 ...
 * @module @const-ai/agent-loop/invariant
 */

import type { Context } from '@const-ai/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@const-ai/llm'
import type { InvariantFailure, InvariantInstaller } from '@const-ai/invariants'
import { foldRequestHeader } from '@const-ai/session'

const PACKAGE_NAME = '@const-ai/agent-loop'
