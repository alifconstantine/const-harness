...
import { Context, FiberState, getTraceable, Service, symbols } from '@const-ai/cordis'
 ...
 * (`@const-ai/agent-loop`), registered via {@link setFactory}.
 *
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('agent', {
        parameter: 'agent',
        wire: 'agentId',
        hostTypeSymbol: '@const-ai/agent#Agent',
