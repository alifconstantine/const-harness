 ...
 * turn/step boundaries remain `@const-ai/session` events.
 *
 * @module @const-ai/agent
 */

import type { Context } from '@const-ai/cordis'
import type { Scoped } from '@const-ai/scope'
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@const-ai/llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@const-ai/session'
export type { AgentCancelCause } from '@const-ai/session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@const-ai/system-prompt'
declare module '@const-ai/system-prompt' {
...
declare module '@const-ai/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@const-ai/scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
