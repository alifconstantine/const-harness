/**
 * Package-owned invariant companion for `@const-ai/agent-tool-presentation`.
 * @module @const-ai/agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@const-ai/agent-tool-presentation'
