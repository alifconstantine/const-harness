/**
 * Unit + real-load-path coverage for @const-ai/tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@const-ai/llm'
import SystemPrompt from '@const-ai/system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@const-ai/tools'
import * as timeoutPolicy from '@const-ai/tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@const-ai/tool-call-timeout-policy'
