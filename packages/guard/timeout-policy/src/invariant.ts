/**
 * Package-owned invariant companion for `@const-ai/tool-call-timeout-policy`.
 * @module @const-ai/tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@const-ai/tool-call-timeout-policy'
