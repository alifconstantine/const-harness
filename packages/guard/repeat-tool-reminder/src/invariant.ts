/**
 * Package-owned invariant companion for `@const-ai/repeat-tool-reminder`.
 * @module @const-ai/repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@const-ai/repeat-tool-reminder'
