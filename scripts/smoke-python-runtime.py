...
- id: sdk-jsonrpc-server
  name: '@const-ai/sdk-jsonrpc-server'
- id: agent-core
  name: '@const-ai/agent-spine-demo'
  config:
...
- id: sessions
  ...
  config:
    ...
    compression: 'none'
- id: code-runtime
  name: '@const-ai/code-runtime-worker-thread'
- id: subagents
  name: '@const-ai/subagent'
- id: subagent-spawn-in-process
  name: '@const-ai/subagent-spawn-in-process'
  config:
    providerName: spawn
- id: subagent-tool
  name: '@const-ai/tool-subagent'
  config:
    provider: spawn
- id: workflow-engine
  name: '@const-ai/workflow-worker-thread'
  config:
    provider: spawn
- id: workflow-tool
  name: '@const-ai/tool-workflow'
- id: cordis-host-runner
  name: '@const-ai/cordis-host-runner'
- id: cordis-tool
  name: '@const-ai/tool-cordis'
"""
