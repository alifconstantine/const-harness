...
import type { CordisCatalogModel, ServiceMethodEntry } from '@const-ai/typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@const-ai/tool-cordis/api-catalog', '@const-ai/cordis-client-runner/client/api-catalog')
