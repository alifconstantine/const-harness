...
class ScopedEventGenerator {
  ...
  render(): string {
    ...
    return [
      ...
      ' *',
      ' * @module @const-ai/scope/scoped-events.generated',
      ' */',
      '',
...
/** Return whether an Events interface is inside declare module '@const-ai/cordis'. */
function isCordisModuleInterface(node: ts.InterfaceDeclaration): boolean {
  ...
  return ts.isModuleBlock(block)
    ...
    && declaration.name.text === '@const-ai/cordis'
}
